...
class M_agen extends CI_Model {
	...
	public function select_all() {
		$sql = " SELECT * FROM pendaftaran order by id_daftar";
	...
	public function select_by_posisi($id) {
		$sql = "SELECT COUNT(*) AS jml FROM pendaftaran WHERE pilihan1 = {$id}";
	...
	public function select_by_kota($id) {
		$sql = "SELECT COUNT(*) AS jml FROM pendaftaran WHERE tempat_ujian = {$id}";
