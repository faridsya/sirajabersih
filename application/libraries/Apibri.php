...
class Apibri
{
	...
	var $clientID     = "VXMCcM7zipjDNIJtKFvRUAsKw81y6KRh";
	var $clientSecret = "dqWTsxdiA5GF8AbW";
	...
	var $expiredDate = "2022-03-27 23:59:00"; //static
	//Hh9tqB#c5B2ax#Y
	...
	/* Create BRIVA  */
	function create($custcode,$nama,$amount,$tanggalexpired) {

		$institutionCode = $this->institutionCode;
		$brivaNo = $this->brivaNo;
		$keterangan="Pembayaran Pendaftaran NHI";
